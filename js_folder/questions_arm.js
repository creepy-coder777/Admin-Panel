// Open modal when any "Ավելացնել Հարց" button is clicked
...
function saveNewQuestion() {
  ...
  if (!text) {
    alert("Խնդրում ենք մուտքագրել հարց։");
    return;
  }
  ...
  if (saveNewQuestion.mode === "edit" && saveNewQuestion.target) {
    ...
    newQuestion.innerHTML = `
      ...
      <div class="rating-scale">
        <span class="rating-label">Ռեյթինգի Սանդղակ:</span>
